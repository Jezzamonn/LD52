...
export class TouchKeys extends RegularKeys {
    ...
    addButtonListener(elemOrSelector: HTMLElement | Window | string, keyCode: string): void {
        ...
        elem.addEventListener('touchstart', updateFromTargetTargets as any);
        elem.addEventListener('touchend', updateFromTargetTargets as any);
        elem.addEventListener('touchcancel', updateFromTargetTargets as any);
    }
